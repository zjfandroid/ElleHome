...
public class LuminaireControlPacket extends BasicPacket {
	...
	public LuminaireControlPacket(InetAddress ip, int port) {
		super(ip, port);
		// TODO Auto-generated constructor stub
	}
	
	public void lightOpen(byte[] mac,OnRecvListener listener){
		super.packData(PublicDefine.TypeBigLight, PublicDefine.LightVerOrgin, PublicDefine.FunLightOpen, mac, PublicDefine.getPhoneMac(), PublicDefine.getSeq(), null);
		super.setListener(listener);
	}
	
	public void lightClose(byte[] mac,OnRecvListener listener){
		super.packData(PublicDefine.TypeBigLight, PublicDefine.LightVerOrgin, PublicDefine.FunLightClose, mac, PublicDefine.getPhoneMac(), PublicDefine.getSeq(), null);
		super.setListener(listener);
	}
	...
	public void lightFree(byte[] mac,OnRecvListener listener,boolean status){
		...
		super.packData(PublicDefine.TypeBigLight, PublicDefine.LightVerOrgin, PublicDefine.FunLightRandom, mac, PublicDefine.getPhoneMac(), PublicDefine.getSeq(), tmp);
		super.setListener(listener);
	}
	...
	public void lightColor(byte[] mac,OnRecvListener listener,int red,int green,int blue,int white,int lux,int time){
		...
		super.packData(PublicDefine.TypeBigLight, PublicDefine.LightVerOrgin, PublicDefine.FunLightColor, mac, PublicDefine.getPhoneMac(), PublicDefine.getSeq(), xdata);
		super.setListener(listener);
	}
	...
	public void lightSleep(byte[] mac,OnRecvListener listener,int time){
		...
		super.packData(PublicDefine.TypeBigLight, PublicDefine.LightVerOrgin, PublicDefine.FunLightSleep, mac, PublicDefine.getPhoneMac(), PublicDefine.getSeq(), xdata);
		super.setListener(listener);
	}
	
	public void lightCheck(byte[] mac,OnRecvListener listener){
		super.packData(PublicDefine.TypeBigLight, PublicDefine.LightVerOrgin, PublicDefine.FunCheck, mac, PublicDefine.phonemac, PublicDefine.getSeq(), null);
		super.setListener(listener);
	}
}
