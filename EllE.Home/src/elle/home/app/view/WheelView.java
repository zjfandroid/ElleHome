...
import elle.home.utils.ABTextUtil;
...
//        int padding = ABTextUtil.dip2px(context, 5);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                ...
                itemView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 128);
                padding = ABTextUtil.dip2px(context, -38);
            } else {
                itemView.setTextColor(Color.parseColor("#f5f5f5"));
                itemView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 80);
            }
            
            if(position-1 == i){
            	padding = ABTextUtil.dip2px(context, -25);
            }else if(position + 1 ==i){
            	padding = ABTextUtil.dip2px(context, -26);
            }
