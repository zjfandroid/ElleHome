...
public class SceneItemDevFun extends LinearLayout {
	...
	public ArrayList<HashMap<String,Object>> getShowData(byte type){
		...
		case PublicDefine.TypeLight:
			...
			map1.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightOnIcon));
			map1.put("funname", getContext().getResources().getString(R.string.scene_fun_light_on));
			tmp.add(map1);
			HashMap<String,Object> map2 = new HashMap<String,Object>();
			map2.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightOffIcon));
			map2.put("funname", getContext().getResources().getString(R.string.scene_fun_light_off));
			tmp.add(map2);
			HashMap<String,Object> map3 = new HashMap<String,Object>();
			map3.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightFreeIcon));
			map3.put("funname", getContext().getResources().getString(R.string.scene_fun_light_random));
			tmp.add(map3);
			HashMap<String,Object> map4 = new HashMap<String,Object>();
			map4.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightNullIcon));
			map4.put("funname", getContext().getResources().getString(R.string.scene_fun_light_cancel));
			tmp.add(map4);
			HashMap<String,Object> map5 = new HashMap<String,Object>();
			map5.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor1));
			map5.put("funname", getContext().getResources().getString(R.string.scene_fun_light_orange));
			tmp.add(map5);
			HashMap<String,Object> map6 = new HashMap<String,Object>();
			map6.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor2));
			map6.put("funname", getContext().getResources().getString(R.string.scene_fun_light_green));
			tmp.add(map6);
			HashMap<String,Object> map7 = new HashMap<String,Object>();
			map7.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor3));
			map7.put("funname", getContext().getResources().getString(R.string.scene_fun_light_blue));
			tmp.add(map7);
			HashMap<String,Object> map8 = new HashMap<String,Object>();
			map8.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor4));
			map8.put("funname", getContext().getResources().getString(R.string.scene_fun_light_red));
			tmp.add(map8);
			HashMap<String,Object> map9 = new HashMap<String,Object>();
			map9.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor5));
			map9.put("funname", getContext().getResources().getString(R.string.scene_fun_light_yellow));
			tmp.add(map9);
			HashMap<String,Object> map10 = new HashMap<String,Object>();
			map10.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor6));
			...
			map11.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor7));
			...
			map12.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneLightColor8));
		...
		case PublicDefine.TypePlug:
			...
			xmap1.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.ScenePlugOnIcon));
			...
			xmap2.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.ScenePlugOffIcon));
			...
			xmap3.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.ScenePlugNullIcon));
		...
		case PublicDefine.TypeInfraAir:
			...
			amap16.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirCold16));
			...
			amap24.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirCold24));
			...
			amap30.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirCold30));
			...
			amap3.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirCloseIcon));
			...
			wmap16.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirWarm16));
			...
			wmap24.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirWarm24));
			...
			wmap30.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirWarm30));
			...
			amap4.put("funlogo", PublicDefine.getIconByTypeFun(type,PublicDefine.SceneInfraAirNullIcon));
