...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public static final int TAG_RIGHT = 20;
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, int tag);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOffButton = (TextView) view.findViewById(R.id.right_button);
        ...
        mOffButton.setOnKeyListener(keyboardListener);
    ...
    private void onOffButtonClick() {
    	...
    	if (mCallback != null) {
    		mCallback.onTimeSet(mTimePicker,
    				mTimePicker.getHours(), mTimePicker.getMinutes(), TAG_RIGHT);
    	}
    	dismiss();
    }
    ...
    private void onDoneButtonClick() {
        ...
        if (mCallback != null) {
            mCallback.onTimeSet(mTimePicker,
                    mTimePicker.getHours(), mTimePicker.getMinutes(), TAG_LEFT);
        }
        dismiss();
    }
    ...
    private void setTimeChange(){
    	timeChangeCount++;
        if(timeChangeCount == 4){
        	mDoneButton.setText(R.string.done_label);
        	mOffButton.setText(R.string.off_label);
        }
    }
