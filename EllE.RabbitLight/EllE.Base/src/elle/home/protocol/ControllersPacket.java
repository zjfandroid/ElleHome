...
public class ControllersPacket extends BasicPacket {
	 ...
	 * @param listener
	 */
//	public void getGateWayMac(int index, byte[] mac,OnRecvListener listener){
//		super.packZigbeeData(PublicDefine.TypeController, PublicDefine.VerControllers[index], PublicDefine.FunGetGateWayMac, 
//				mac, PublicDefine.phonemac, PublicDefine.getSeq(), null);
//		super.setListener(listener);
//	}
